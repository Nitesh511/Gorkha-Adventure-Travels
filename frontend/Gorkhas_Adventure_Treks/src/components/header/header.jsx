...
import logo from "../../assets/gorkha.png";

const Header = () => {
  // State to track the visibility of the menu items
  ...
  return (
    <div>
      <nav className="bg-light-green border-gray-200 dark:bg-green-800 fixed top-0 w-full z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={logo} className="h-8" alt="Flowbite Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Gurkhas Adventure Treks And Travels </span>
          </a>
